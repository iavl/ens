...
contract OldBaseRegistrarImplementation is BaseRegistrar, ERC721 {
    ...
    uint256 public transferPeriodEnds;
    ...
    uint256 public constant MIGRATION_LOCK_PERIOD = 28 days;
    ...
    constructor(
        ENS _ens,
        HashRegistrar _previousRegistrar,
        bytes32 _baseNode,
        uint256 _transferPeriodEnds
    ) public {
